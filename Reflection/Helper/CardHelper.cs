...
namespace Reflection.Helper
{
    ...
    {
      public async static Task<MessagingExtensionActionResponse> SendNewPost(MessagingExtensionAction action, CancellationToken cancellationToken, string Data, Guid? reflectionId)
     {
            string card = "{\r\n    \"type\": \"AdaptiveCard\",\r\n    \"version\": \"1.0\",\r\n    \"body\": [\r\n        {\r\n            \"type\": \"ColumnSet\",\r\n            \"columns\": [\r\n                {\r\n                    \"type\": \"Column\",\r\n                    \"width\": \"stretch\",\r\n                    \"items\": [\r\n                        {\r\n                            \"type\": \"TextBlock\",\r\n                            \"text\": \"Created by: Arun Kumar\"\r\n                        }\r\n                    ]\r\n                },\r\n                {\r\n                    \"type\": \"Column\",\r\n                    \"width\": \"stretch\",\r\n                    \"items\": [\r\n                        {\r\n                            \"type\": \"TextBlock\",\r\n                            \"text\": \"| Responses are public\"\r\n                        }\r\n                    ]\r\n                }\r\n            ]\r\n        },\r\n        {\r\n            \"type\": \"Container\",\r\n            \"items\": [\r\n                {\r\n                    \"type\": \"TextBlock\",\r\n                    \"text\": \"How are you felling about the test today?\"\r\n                }\r\n            ]\r\n        },\r\n        {\r\n            \"type\": \"ColumnSet\",\r\n            \"columns\": [\r\n                {\r\n                    \"type\": \"Column\",\r\n                    \"width\": \"stretch\",\r\n                    \"items\": [\r\n                        {\r\n                                \"type\": \"Image\",\r\n                                \"url\": \"https://bc5066ec.ngrok.io/images/1.png\",\r\n                                \"altText\":\"1\",\r\n                                \"selectAction\": {\r\n                                                    \"type\": \"Action.Submit\"\r\n                                                }\r\n                        }\r\n                    ]\r\n                },\r\n                {\r\n                    \"type\": \"Column\",\r\n                    \"width\": \"stretch\",\r\n                    \"items\": [\r\n                        {\r\n                                \"type\": \"Image\",\r\n                                \"url\": \"https://bc5066ec.ngrok.io/images/2.png\",\r\n                                \"altText\":\"2\",\r\n                                \"selectAction\": {\r\n                                                    \"type\": \"Action.Submit\"\r\n                                                }\r\n                        }\r\n                        \r\n                    ]\r\n                },\r\n                {\r\n                    \"type\": \"Column\",\r\n                    \"width\": \"stretch\",\r\n                    \"items\": [\r\n                        {\r\n                                \"type\": \"Image\",\r\n                                \"url\": \"https://bc5066ec.ngrok.io/images/3.png\",\r\n                                \"altText\":\"3\",\r\n                                \"selectAction\": {\r\n                                                    \"type\": \"Action.Submit\"\r\n                                                }\r\n                        }\r\n                    ]\r\n                },\r\n                {\r\n                    \"type\": \"Column\",\r\n                    \"width\": \"stretch\",\r\n                    \"items\": [\r\n                        {\r\n                                \"type\": \"Image\",\r\n                                \"url\": \"https://bc5066ec.ngrok.io/images/4.png\",\r\n                                \"altText\":\"4\",\r\n                                \"selectAction\": {\r\n                                                    \"type\": \"Action.Submit\"\r\n                                                }\r\n                        }\r\n                    ]\r\n                },\r\n                {\r\n                    \"type\": \"Column\",\r\n                    \"width\": \"stretch\",\r\n                    \"items\": [\r\n                        {\r\n                                \"type\": \"Image\",\r\n                                \"url\": \"https://bc5066ec.ngrok.io/images/5.png\",\r\n                                \"altText\":\"5\",\r\n                                \"selectAction\": {\r\n                                                    \"type\": \"Action.Submit\"\r\n                                                }\r\n                        }\r\n                    ]\r\n                }\r\n            ]\r\n        }\r\n    ],\r\n    \"actions\": [\r\n          {\r\n            \"type\": \"Action.Submit\",\r\n            \"title\": \"Remove Post\"\r\n          },\r\n          {\r\n            \"type\": \"Action.Submit\",\r\n            \"title\": \"Manage recurring posts\"\r\n          }\r\n        ],\r\n    \"$schema\": \"http://adaptivecards.io/schemas/adaptive-card.json\"\r\n}";
